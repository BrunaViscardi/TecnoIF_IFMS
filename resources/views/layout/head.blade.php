<head>
    ...
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/icheck-bootstrap/icheck-bootstrap.css')}}">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/jqvmap/jqvmap.min.css')}}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/dist/css/adminlte.min.css')}}">
    <!-- overlayScrollbars -->
    ...
    <!-- fullCalendar -->
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/fullcalendar/main.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/fullcalendar-daygrid/main.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/fullcalendar-timegrid/main.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/AdminLTE-3.0.5/plugins/fullcalendar-bootstrap/main.min.css')}}">
